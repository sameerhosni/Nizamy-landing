...
export function Hero() {
  ...
  const content = {
    en: {
      ...
      subtitle:
        "The first performance-driven HR platform that returns up to 30% of your subscription cost based on actual team improvement.",
    ...
    ar: {
      ...
      subtitle:
        "أول منصة موارد بشرية مبنية على الأداء، تعيد لك حتى 30% من قيمة اشتراكك السنوي بناءً على التحسن الفعلي في أداء فريقك.",
        ...
        <div className="max-w-4xl mx-auto text-center space-y-10 animate-in fade-in slide-in-from-bottom-12 duration-1000">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button
              ...
              onClick={() => {
                posthog.capture("early_access_cta_clicked", {
                  location: "hero",
                  language,
                });
                document
            ...
            <Button
              ...
              onClick={() => {
                posthog.capture("see_the_math_clicked", { language });
                document
                  .getElementById("return-model")
                  ?.scrollIntoView({ behavior: "smooth" });
              }}
            >
              {t.secondaryCta}
